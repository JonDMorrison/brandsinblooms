-- Pause / Resume sending for a campaign.
-- Pausing stops future worker claims by marking jobs/messages as paused.
...
BEGIN
  ...
  SELECT COUNT(*)::INT INTO jobs_paused FROM j;
...
BEGIN
  ...
  SELECT COUNT(*)::INT INTO jobs_resumed FROM j;
