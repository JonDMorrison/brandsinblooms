...
RETURNS TABLE (
  ...
  recent_customers_30d BIGINT,
  total_customer_revenue NUMERIC,
  current_month_customers BIGINT,
  previous_month_customers BIGINT,
  current_month_customer_revenue NUMERIC,
  previous_month_customer_revenue NUMERIC,
  total_campaigns BIGINT,
  active_campaigns BIGINT,
  current_month_campaigns BIGINT,
  previous_month_campaigns BIGINT,
  avg_open_rate NUMERIC,
  avg_click_rate NUMERIC,
  overall_conversion_rate NUMERIC,
  current_month_conversion_rate NUMERIC,
  previous_month_conversion_rate NUMERIC,
...
BEGIN
  ...
  SELECT
    ...
    customer_summary.recent_customers_30d,
    customer_summary.total_customer_revenue,
    customer_summary.current_month_customers,
    customer_summary.previous_month_customers,
    customer_summary.current_month_customer_revenue,
    customer_summary.previous_month_customer_revenue,
    campaign_summary.total_campaigns,
    campaign_summary.active_campaigns,
    campaign_summary.current_month_campaigns,
    campaign_summary.previous_month_campaigns,
    campaign_summary.avg_open_rate,
    campaign_summary.avg_click_rate,
    campaign_summary.overall_conversion_rate,
    campaign_summary.current_month_conversion_rate,
    campaign_summary.previous_month_conversion_rate,
    COALESCE(segment_counts_json.segment_counts, '{}'::JSONB),
    COALESCE(persona_counts_json.persona_counts, '{}'::JSONB)
