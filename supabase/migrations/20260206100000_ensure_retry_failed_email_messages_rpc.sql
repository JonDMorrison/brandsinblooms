-- Ensure the base retry_failed_email_messages(uuid,int) RPC exists.
-- Some environments can end up with migration history drift where the wrapper exists but the base overload is missing.
