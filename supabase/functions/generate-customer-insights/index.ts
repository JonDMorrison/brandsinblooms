...
- Total orders: ${purchaseMetrics?.total_purchases || 0}
...
- Discount ratio: ${purchaseMetrics?.discount_driven_ratio ? (purchaseMetrics.discount_driven_ratio * 100).toFixed(0) + "%" : "N/A"}

**Risk Indicators:**
- Risk score: ${riskSignals?.overall_risk_score || "N/A"}
- Churn score: ${lifecycleMetrics?.churn_risk_score || "N/A"}
...
Provide your analysis in the following JSON format:`;
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        tools: [
          {
            ...
            function: {
              ...
              description:
                "Provide structured customer insights and recommended actions",
              parameters: {
                type: "object",
                properties: {
                  keyInsight: {
                    type: "string",
                    description:
                      "A 2-3 sentence key insight about this customer that is specific and actionable",
                  },
                  patterns: {
                    type: "array",
                    items: { type: "string" },
                    description:
                      "List of 3-5 behavioral patterns observed (be specific with data references)",
                  },
                  actions: {
                    type: "array",
                    items: {
                      ...
                      properties: {
                        title: {
                          type: "string",
                          description: "Short action title (max 60 chars)",
                        },
                        description: {
                          type: "string",
                          description:
                            "Brief explanation of why this action matters",
                        },
                        confidence: {
                          type: "number",
        ...
        tool_choice: {
          type: "function",
          function: { name: "provide_customer_insights" },
        },
        max_tokens: 1000,
        temperature: 0.7,
      }),
