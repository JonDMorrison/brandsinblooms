...
export const extractKeywords = (
  ...
  if (foundTerms.size > 0) {
    ...
    const invalidTerms =
      /\b(ice.?cream|dessert|sweet|food|restaurant|cafe|%|percent|symbol|sign|math|number)\b/i;
