...
export async function runLocationPersistenceIntegrationTest(
  ...
  console.log('🧪 Starting location persistence integration test for user:', testUserId);
  
  // Test 1: Analyze Portland Nursery (multi-location site)
  console.log('🧪 Test 1: Analyzing multi-location website...');
  try {
    ...
    results.push({
      ...
      details: {
        ...
        candidates: locationExtraction.candidates.map((c: any) => c.postal_code)
      }
    });
    ...
    console.log('🧪 Test 2: Persisting location extraction...');
    ...
    console.log('🧪 Test 3: Verifying database state...');
