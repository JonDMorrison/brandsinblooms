// Quick automation templates for Square integration setup wizard
...
export const SQUARE_QUICK_AUTOMATIONS: QuickAutomation[] = [
  {
  ...
  },
  {
    ...
    description: 'Welcome new customers when they\'re added to Square',
...
export const getRecommendedAutomations = () => 
  SQUARE_QUICK_AUTOMATIONS.filter(a => a.recommended);

export const getAutomationById = (id: string) => 
  SQUARE_QUICK_AUTOMATIONS.find(a => a.id === id);
