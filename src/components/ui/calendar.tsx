  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: "flex items-center justify-between w-full px-1 pb-2 order-first",
        caption_label: "text-sm font-semibold text-foreground order-first",
        nav: "flex items-center gap-1 ml-auto",
        button_previous: cn(
          "h-6 w-6 inline-flex items-center justify-center rounded border border-input bg-background hover:bg-accent hover:text-accent-foreground transition-colors"
        ),
        button_next: cn(
          "h-6 w-6 inline-flex items-center justify-center rounded border border-input bg-background hover:bg-accent hover:text-accent-foreground transition-colors"
        ),
