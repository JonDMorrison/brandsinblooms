  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-primary/50 text-primary-foreground border-2 border-primary rounded-md hover:bg-primary/60 hover:text-primary-foreground focus:bg-primary/50 focus:text-primary-foreground",
