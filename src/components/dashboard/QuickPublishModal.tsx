...
export const QuickPublishModal = ({
  ...
  const getOptimalTimes = () => {
    ...
    return [
      {
        label: "In 2 hours (optimal)",
        value: format(addHours(now, 2), "yyyy-MM-dd'T'HH:mm"),
      },
      {
        label: "Tomorrow 9 AM",
        value: format(
          addDays(now, 1).setHours(9, 0, 0, 0),
          "yyyy-MM-dd'T'HH:mm",
        ),
      },
      {
        label: "Tomorrow 2 PM",
        value: format(
          addDays(now, 1).setHours(14, 0, 0, 0),
          "yyyy-MM-dd'T'HH:mm",
        ),
      },
      {
        label: "Tomorrow 6 PM",
        value: format(
          addDays(now, 1).setHours(18, 0, 0, 0),
          "yyyy-MM-dd'T'HH:mm",
        ),
      },
    ];
  ...
  const handlePublish = async () => {
    ...
    try {
      const scheduledDate =
        publishMode === "scheduled" && scheduledTime
