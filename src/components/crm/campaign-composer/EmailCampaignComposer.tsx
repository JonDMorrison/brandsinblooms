...
export const EmailCampaignComposer: React.FC = () => {
    ...
    const defaultBlocks: EmailBlock[] = [
      {
        ...
        type: "heading",
        content: {
          text: "Welcome to Our Garden Center!",
          level: 1,
          align: "center",
        },
        order: 0,
      },
      {
        ...
        type: "text",
        content: {
          text: "We're excited to share our latest plants and gardening tips with you.",
        },
        order: 1,
      },
    ];
  ...
  const generateHTML = () => {
    ...
    <head>
      ...
      <style>
        ...
        .container { width: 100%; background-color: white; border-radius: 8px; overflow: hidden; }
  ...
  const saveCampaign = async (sendNow = false) => {
    if (
      ...
      toast({
        ...
        description:
          "Please fill in campaign name, subject line, and select a segment",
        variant: "destructive",
      });
      return;
    }

    // Campaigns require a verified custom domain (no fallback senders)
  ...
  const selectedSegment = segments.find(
    (s) => s.id === campaignData.segment_id,
  );
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Create engaging email campaigns with our drag-and-drop builder
            </p>
          </div>
        </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Drag blocks to add them to your email
              </p>
            </CardHeader>
            <CardContent>
        ...
        <div className="lg:col-span-3">
          <Card>
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Build your email by adding and editing content blocks
              </p>
            </CardHeader>
            <CardContent>
                      ...
                      {blocks.length === 0 && (
                        <div className="text-center py-12 border-2 border-dashed border-muted-foreground/20 rounded-lg">
                          ...
                          <p className="text-muted-foreground mb-4">
                            Add content blocks from the sidebar to create your
                            email campaign
                          </p>
