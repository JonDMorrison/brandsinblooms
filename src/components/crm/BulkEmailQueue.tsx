      ...
      <CardContent className="space-y-4">
        ...
        {totalRecipients > 5000 && status === "idle" && (
          <Alert>
            ...
            <AlertDescription>
              Large campaign detected ({totalRecipients.toLocaleString()}{" "}
              recipients). Estimated time: ~{estimatedTimeMinutes} minutes.
              Sending will happen in background.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span>Progress</span>
            <span>
              {sent.toLocaleString()} / {totalRecipients.toLocaleString()}
            </span>
          </div>
        ...
        {status === "sending" && estimatedTimeMinutes > 0 && (
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            {Math.ceil((totalRecipients - sent) / EMAILS_PER_MINUTE)} min
          </div>
        )}
        ...
        <Alert variant="default">
          <AlertDescription className="text-xs">
            ...
            {totalRecipients > 1000 &&
              " Large campaigns are processed in the background to ensure reliability."}
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
