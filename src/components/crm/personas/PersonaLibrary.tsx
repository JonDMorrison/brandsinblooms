...
export function PersonaLibrary({
  ...
  const filterTypes = [
    ...
    {
      label: "Style-Seeker",
      keywords: ["style", "design", "trendy", "curb appeal"],
    },
    {
      label: "Eco-Conscious",
      keywords: ["sustainable", "organic", "native", "eco"],
    },
    {
      label: "Health & Wellness",
      keywords: ["wellness", "therapeutic", "health"],
    },
  ];
  ...
  const filteredPersonas = personas.filter((persona) => {
    ...
    const matchesType = typeFilter.keywords.some(
      (keyword) =>
        persona.buying_triggers.some((trigger) =>
      ...
      <div className="bg-card rounded-lg shadow-2xl w-[95vw] sm:w-[90vw] max-w-[1400px] h-[95vh] sm:h-[90vh] flex flex-col overflow-hidden border border-border">
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <CardTitle className="text-sm sm:text-lg text-card-foreground truncate">
                          {persona.name}
                        </CardTitle>
        ...
        <div className="sticky bottom-0 p-3 sm:p-4 bg-muted/30 border-t border-border flex-shrink-0">
          <p className="text-xs text-muted-foreground text-center">
            <strong>What this does:</strong> Assigning a persona helps
            personalize content, trigger smarter automations, and unlock
            AI-generated campaigns tailored to your customers' values and
            habits.
          </p>
        </div>
      </div>
