...
export const CustomerSegmentsSection: React.FC = () => {
  ...
  return (
    <div
      className={`${isMobile ? "mobile-space-normal" : "space-y-4"} mobile-container`}
    >
      ...
      <Card className="mobile-card-elevated">
        <CardHeader className={isMobile ? "p-4 pb-2" : ""}>
          ...
          >
            ...
            >
              View All Segments
              <ArrowRight
                className={`${isMobile ? "mobile-icon-sm" : "h-4 w-4"} ml-2`}
              />
            </Button>
          </div>
        </CardHeader>
        <CardContent className={isMobile ? "p-4 pt-2" : ""}>
          <div
            className={`${isMobile ? "mobile-grid-1" : "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3"} ${isMobile ? "gap-4" : "gap-4"}`}
          >
