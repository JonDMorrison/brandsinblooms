...
const layoutOptions = [
  // NEW: Email-safe hero blocks at the top (recommended for emails)
  {
    ...
    description:
      "Recommended – text on solid background, image below. Dark mode friendly.",
    category: "Hero",
  ...
  },
  {
    ...
    title: "Graphic Hero",
    description:
      "Single image with text baked in. Use when you design the hero in Canva.",
    category: "Hero",
  ...
  // Enhanced Image Layouts
  {
    ...
    description:
      "Responsive image that spans the full email width with optional caption",
    category: "Image",
...
export const EnhancedBlockLayoutModal: React.FC<
  EnhancedBlockLayoutModalProps
