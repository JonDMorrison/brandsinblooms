...
export const TextBlockEditor: React.FC<TextBlockEditorProps> = ({
  ...
  useEffect(() => {
    ...
    const hasExplicitImageLayout = explicitImageLayouts.includes(
      block.layout || "",
    );

    if (
      hasExplicitImageLayout &&
      !block.imageUrl &&
      ...
      if (contentForImage) {
        mediaSelector({
          ...
          .catch((error) => {
            console.error(
              "[TextBlockEditor] Failed to auto-fetch image:",
              error,
            );
          });
      }
    ...
    <div className="space-y-4">
      ...
      {showPreview && (
        <Card className="p-4 bg-muted/30">
          ...
          <div
            className={`${getPreviewLayoutClass(block.layout)} gap-4 items-start`}
          >
            ...
            {hasImageLayout && (
              <div
                className={`${getImagePreviewClass(block.layout)} bg-muted rounded flex items-center justify-center flex-shrink-0`}
              >
                {block.imageUrl ? (
                  <img
                    src={block.imageUrl}
        ...
        <TabsContent value="layout" className="space-y-4 mt-4">
          <div>
            ...
            <NativeSelect
              ...
              onChange={(e) =>
                onUpdate({ layout: e.target.value as BlockLayout })
              }
              options={[
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <NativeSelect
                ...
                onChange={(e) =>
                  onUpdate({ padding: e.target.value as SpacingType })
                }
                options={[
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <NativeSelect
                    ...
                    onChange={(e) =>
                      onUpdate({ imageSize: e.target.value as ImageSizeType })
                    }
                    options={[
                      { value: "small", label: "Small" },
                      { value: "medium", label: "Medium" },
                ...
                <div>
                  ...
                  <NativeSelect
                    ...
                    onChange={(e) =>
                      onUpdate({
                        imagePosition: e.target.value as ImagePositionType,
                      })
                    }
                    options={[
                      { value: "left", label: "Left" },
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      onUpdate({ imageRounded: checked })
                    }
                  />
                  <Label htmlFor="image-rounded" className="text-sm">
                    Rounded
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      onUpdate({ imageShadow: checked })
                    }
                  />
                  <Label htmlFor="image-shadow" className="text-sm">
                    Shadow
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      onUpdate({ imageBorder: checked })
                    }
                  />
                  <Label htmlFor="image-border" className="text-sm">
                    Border
                  </Label>
                </div>
              </div>
        ...
        <TabsContent value="style" className="space-y-4 mt-4">
          ...
          <div>
            ...
            <NativeSelect
              ...
              onChange={(e) =>
                onUpdate({ responsiveBehavior: e.target.value as any })
              }
              options={[
