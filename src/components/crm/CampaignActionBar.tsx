  ...
  return (
    <>
      ...
      <div className={`sticky top-0 z-50 ${isSticky ? 'flex justify-end' : 'w-full'} ${className}`}>
        <div className={`${isSticky ? 'inline-flex px-4 py-2 backdrop-blur-sm border border-border rounded-md shadow-sm' : 'w-full -mx-8 px-6 py-4 backdrop-blur-sm border-b'}`} style={{ backgroundColor: '#fbf9f4' }}>
