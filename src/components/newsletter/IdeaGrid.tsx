      ...
      <div className="max-w-6xl mx-auto">
        <div className="h-full w-full relative">
          <Swiper
            ...
            className="!pb-16 !pt-8 newsletter-idea-slider !h-[calc(100vh-280px)] !relative !z-40 overflow-visible [&_.swiper-button-next]:!bg-white [&_.swiper-button-prev]:!bg-white [&_.swiper-button-next]:!text-gray-600 [&_.swiper-button-prev]:!text-gray-600 [&_.swiper-button-next]:!w-10 [&_.swiper-button-prev]:!w-10 [&_.swiper-button-next]:!h-10 [&_.swiper-button-prev]:!h-10 [&_.swiper-button-next]:!text-xs [&_.swiper-button-prev]:!text-xs [&_.swiper-button-next]:!rounded-full [&_.swiper-button-prev]:!rounded-full [&_.swiper-button-next]:!shadow-lg [&_.swiper-button-prev]:!shadow-lg [&_.swiper-button-next]:!border [&_.swiper-button-prev]:!border [&_.swiper-button-next]:!border-gray-200 [&_.swiper-button-prev]:!border-gray-200 [&_.swiper-button-next]:hover:!bg-gray-50 [&_.swiper-button-prev]:hover:!bg-gray-50 [&_.swiper-button-next]:hover:!text-gray-800 [&_.swiper-button-prev]:hover:!text-gray-800 [&_.swiper-button-next]:!transition-all [&_.swiper-button-prev]:!transition-all [&_.swiper-button-next]:!duration-300 [&_.swiper-button-prev]:!duration-300"
          >
