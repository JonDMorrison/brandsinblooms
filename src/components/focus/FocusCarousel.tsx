...
export const FocusCarousel = ({ onTaskUpdate }: FocusCarouselProps) => {
  ...
  const { themes, filters, loading, updateFilters, skipTheme, markGenerated } =
    useFocusThemes();
  ...
  if (themes.length === 0) {
    return (
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md p-6 h-[300px] flex flex-col items-center justify-center border border-white/20">
        <h3 className="text-lg font-semibold text-[#3E5A6B] mb-2">
          No Themes Available
        </h3>
        <p className="text-gray-600 text-center mb-4">
          All themes have been generated or skipped. Adjust your filters to see
          more options.
        </p>
