    ...
    <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
      <CardHeader>
        ...
        <CardDescription className="text-green-700">
          Your approved content appears here when ready for publishing
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="text-center py-8">
          ...
          <p className="text-sm text-green-700 max-w-md mx-auto">
            Once you approve content from the Review Queue, it will appear here ready for publishing to your social media platforms.
          </p>
        </div>
      </CardContent>
    </Card>
