...
export const CampaignCard = ({
  ...
  const isPreviewCampaign =
    campaign?.title?.includes("PREVIEW") || campaign?.week_number === 99;
      ...
      <Card className="shadow-xl border-gray-200 rounded-xl overflow-hidden">
        <CardContent className="text-center py-12">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            Create a new campaign to generate professional marketing content for
            your garden center
          </p>
        </CardContent>
      </Card>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription
              className={`font-medium ${isPreviewCampaign ? "text-blue-100" : "text-green-100"}`}
            >
              {campaign.title}
            </CardDescription>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4 text-sm text-gray-600 font-medium">
            ...
            >
              ...
              Week{" "}
              {campaign.week_number === 99
                ? "Preview"
                : campaign.week_number || getCurrentWeekNumber()}
            </span>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <DevPreviewBadge
                        show={isPreviewTask && isDeveloper}
                        size="sm"
                      />
