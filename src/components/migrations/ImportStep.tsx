  ...
  const startImport = async () => {
    ...
    try {
      ...
      const { data: validation, error: validationError } =
        await invokeWithRetry(validateFunction, { jobId });
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Import contacts, consent, tags, and segments with optimized batch
            processing.
          </p>
        </div>
        ...
        <div className="flex justify-between">
          ...
          {!isComplete && (
            <Button onClick={startImport} disabled={importing || validating}>
              {importing ? (
                <>
