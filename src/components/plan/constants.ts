...
export const PLAN_THEMES = [
  {
    ...
    label: "Fall Planting",
    description:
      "Perfect for fall gardening season with planting guides and seasonal tips",
  },
  {
    id: "houseplant-month",
    label: "Houseplant Month",
    description:
      "Indoor plant care, winter houseplant tips, and holiday plant gifts",
  },
  {
    id: "pollinator-week",
    label: "Pollinator Week",
    description:
      "Bee-friendly plants, pollinator gardens, and environmental awareness",
  },
  {
    id: "holiday-gifting",
  ...
  },
  {
    ...
    description:
      "Seed starting, vegetable gardening, and growing your own food",
  },
  {
...
export type PlanItemImageGenerationStatus =
  | "pending"
  | "generating"
  | "completed"
  | "failed";

export interface PlanItemEnhancedContent {
  title?: string;
  fullContent?: string;
  summary?: string;
  blocks?: unknown[];
...
export interface PlanItem {
  ...
  imageGenerationStatus?: PlanItemImageGenerationStatus;
  ...
  enhancedContent?: PlanItemEnhancedContent;
}

// Template content generators
export const generatePlanContent = (
  theme: PlanTheme,
  month: string,
): PlanItem[] => {
  ...
  const week4 = new Date(
    Math.min(firstDay.getTime() + 28 * 24 * 60 * 60 * 1000, lastDay.getTime()),
  );
