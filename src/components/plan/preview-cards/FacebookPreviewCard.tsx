    ...
    <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 bg-white dark:bg-card border-2 hover:border-primary/40">
      ...
      <CardContent className="p-0">
        ...
        <button
          ...
          className="w-full h-72 bg-gradient-to-br from-muted/30 to-muted/50 flex flex-col items-center justify-center border-y hover:from-primary/10 hover:to-primary/20 transition-all duration-300 cursor-pointer group"
        >
