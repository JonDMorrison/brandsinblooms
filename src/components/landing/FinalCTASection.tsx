...
export const FinalCTASection = ({ onGetStarted }: FinalCTASectionProps) => {
  return (
    <section className="final-cta-section py-16 md:py-24 px-6 bg-gradient-to-br from-[#47B881] to-[#3A9B6C] text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="mb-6">
          <Button 
            ...
            size="lg"
            className="final-cta-button bg-white text-[#47B881] border-2 border-white hover:bg-white/95 hover:text-[#47B881] font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            style={{
              boxShadow: '0 8px 16px rgba(0, 0, 0, 0.1)'
            }}
          >
            Start Your Free Trial
            <ArrowRight className="ml-2 h-5 w-5 text-[#47B881]" />
          </Button>
        </div>
