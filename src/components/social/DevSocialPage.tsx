...
const mockTasks = [
  {
    id: "task-1",
    ai_output:
      "This is a sample Facebook post about gardening tips. Perfect for engaging with your audience about seasonal planting and garden maintenance. #Gardening #PlantCare #GreenThumb",
    status: "approved",
    post_type: "facebook",
  ...
  },
  {
    id: "task-2",
    ai_output:
      "Beautiful spring flowers are blooming! 🌸 Here are some tips for keeping your garden vibrant this season. Check out our latest blog post for more detailed advice. #SpringGarden #FlowerPower #GardenLife",
    status: "approved",
    post_type: "instagram",
  ...
  },
  {
    id: "task-3",
    ai_output:
      "Draft content that needs approval before posting to social media platforms.",
    status: "draft",
    post_type: "facebook",
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-blue-700 text-sm">
            This is the development social media interface with mock data. Mock
            connections: {mockConnections.length}, Mock tasks:{" "}
            {mockTasks.length}
          </p>
        </div>
        ...
        <div className="text-center space-y-4">
          <h1 className="text-3xl font-bold text-gray-900">
            Social Media Development Interface
          </h1>
          <p className="text-gray-600">
            Development version with mock data to test social posting features
          </p>
        </div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Test the PostToSocialButton component with different states
              </p>
            </div>
            <Button
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 capitalize">
                        ...
                        Type:{" "}
                        <span className="font-medium">{task.post_type}</span>
                      </p>
                    </div>
                    <div className="ml-4">
                      <PostToSocialButton
