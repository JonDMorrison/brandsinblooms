...
const NEW_PERMISSIONS = [
  { name: 'Loyalty Program Access', description: 'Sync loyalty members and point balances' },
];
...
export const SquareReauthorizationGuide = ({
  ...
  useEffect(() => {
    ...
    const handleMessage = (event: MessageEvent) => {
      if (event.origin === window.location.origin && event.data?.type === 'square_oauth_result') {
  ...
  const startReauthorization = async () => {
    ...
    try {
      ...
      setErrorMessage(error.message || 'Failed to start authorization');
      setCurrentStep('error');
    }
  };
  ...
  const handleSuccess = () => {
    ...
    toast({
      ...
      description: 'Your Square connection now has access to Loyalty Program data.',
    });
  };
            ...
            {STEPS.map((step, idx) => (
              <div
                ...
                className={`text-xs font-medium transition-colors ${
                  idx <= getStepIndex() ? 'text-primary' : 'text-muted-foreground'
                }`}
              >
                {step.label}
              </div>
        ...
        <div className="min-h-[280px] flex flex-col">
          {currentStep === 'intro' && (
            <div className="flex-1 flex flex-col">
              ...
              <div className="mt-auto flex gap-3">
                ...
                <Button onClick={() => setCurrentStep('explain')} className="flex-1">
                  Continue
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm">A Square authorization window will open</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center text-xs font-bold text-primary shrink-0">
                    2
                  </div>
                  <p className="text-sm">You'll see the updated permissions list</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center text-xs font-bold text-primary shrink-0">
                    3
          ...
          {currentStep === 'authorizing' && (
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              <Progress value={authProgress} className="w-full max-w-xs h-2 mb-4" />
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className={authProgress >= 30 ? 'text-green-600' : 'text-muted-foreground'}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={authProgress >= 70 ? 'text-green-600' : 'text-muted-foreground'}>
                    Opening Square
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className={authProgress >= 100 ? 'text-green-600' : 'text-muted-foreground'}>
          ...
          {currentStep === 'success' && (
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              <div className="flex gap-3 w-full mt-auto">
                <Button variant="outline" onClick={handleSuccess} className="flex-1">
                  Close
                </Button>
