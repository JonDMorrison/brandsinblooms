    ...
    try {
      ...
      const storageState = {
        sessionStorage: {
          ...
          processed_oauth_codes: sessionStorage.getItem(
            "processed_oauth_codes",
          ),
          social_connection_success: sessionStorage.getItem(
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex gap-4">
            ...
            <Button variant="outline" onClick={generateFacebookUrl}>
          ...
          {testResults && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {Object.entries(testResults.tests || {}).map(
