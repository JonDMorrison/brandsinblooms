          ...
          {steps.map((step) => (
            ...
            >
              ...
              <div className="w-full min-w-0 overflow-hidden">
                ...
                <div className="text-sm text-slate-600 mt-1 break-words hyphens-auto leading-tight overflow-wrap-anywhere whitespace-normal max-w-full">{step.description}</div>
              </div>
            </Button>
          ))}
        </div>
