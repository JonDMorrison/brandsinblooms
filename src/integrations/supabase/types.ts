  ...
  public: {
    Tables: {
      ...
      automation_email_executions: {
        ...
        Relationships: [
          {
            foreignKeyName: "automation_email_executions_automation_id_fkey";
          ...
          {
            foreignKeyName: "automation_email_executions_customer_id_fkey";
            columns: ["customer_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "automation_email_executions_tenant_id_fkey";
            columns: ["tenant_id"];
            isOneToOne: false;
            referencedRelation: "admin_tenant_overview";
            referencedColumns: ["tenant_id"];
      ...
      customer_segments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_customer_segments_segment";
            columns: ["segment_id"];
            isOneToOne: false;
            referencedRelation: "crm_segments";
            referencedColumns: ["id"];
      ...
      email_messages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "email_messages_retry_of_message_id_fkey";
      ...
      email_test_sends: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_test_sends_automation_id_fkey";
            columns: ["automation_id"];
            isOneToOne: false;
            referencedRelation: "crm_automations";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "email_test_sends_customer_id_fkey";
            columns: ["customer_id"];
            isOneToOne: false;
            referencedRelation: "crm_customers";
            referencedColumns: ["id"];
      ...
      shopify_customers: {
        ...
        Relationships: [
          {
            foreignKeyName: "shopify_customers_contact_id_fkey";
            columns: ["contact_id"];
            isOneToOne: false;
            referencedRelation: "crm_customers";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      admin_backfill_subscription_budgets: {
        Args: { p_month?: string };
        Returns: Json;
      };
      ...
      admin_reset_sync_usage_for_month: {
        Args: { p_month?: string; p_reset_value?: number; p_tenant_id: string };
        Returns: Json;
      };
