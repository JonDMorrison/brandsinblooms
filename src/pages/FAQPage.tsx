...
const FAQPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-muted/30">
      ...
      <section className="py-16 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Everything you need to know about BloomSuite — short, clear answers to help you make the right decision.
          </p>
          ...
          {faqCategories.map((category, categoryIndex) => {
            ...
            return (
              <div key={category.id} id={category.id} className="mb-16 scroll-mt-20">
                ...
                {/* Category CTA */}
                {category.cta && (
                  <div className="mt-8 p-6 bg-gradient-to-r from-primary/5 to-brand-teal-mint/5 border border-primary/10 rounded-lg">
                    <p className="text-center text-muted-foreground">
                      {category.cta.text}{' '}
                      <Button
                        variant="link"
                        onClick={category.cta.onClick}
          ...
          <Card className="p-8 bg-card/95 backdrop-blur-sm border-2 border-primary/20 shadow-xl">
            <div className="text-center">
              ...
              <Button 
                size="lg" 
                onClick={() => navigate('/auth')}
                className="bg-gradient-to-r from-primary to-brand-teal-mint hover:from-primary/90 hover:to-brand-teal-mint/90 text-white px-8 py-4 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
              >
                Book a Demo Call
              </Button>
      ...
      <Button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 rounded-full p-3 shadow-lg bg-primary hover:bg-primary/90 text-white z-50 transition-all hover:scale-110"
        size="icon"
      >
